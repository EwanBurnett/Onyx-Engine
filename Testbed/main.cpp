...
int main() {
    ...
    Onyx::Maths::Quaternion q1 = Onyx::Maths::Quaternion::FromAxisAngle<double>({ 1.0, 1.0, 0.0 }, 90.0);
    Onyx::Log::Print("x, y, z\n");
    for (int i = 0; i < 300000; i++) {
        ...
        Onyx::Log::Print("\r%f, %f, %f", v4.x, v4.y, v4.z);
        //Onyx::Log::Print("%f, %f, %f\n", v4.x, v4.y, v4.z); 
